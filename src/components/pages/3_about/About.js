          ...
          */}
          <Card
            ...
            <div className="centered-container">
              ...
              <FaceCard darkMode={darkMode} name="Sarah Rinzan" subtext={['Droid Hardware Lead']} image={Sr6770} />
              <FaceCard
                darkMode={darkMode}
                name="Aidan Ward"
              ...
              <FaceCard darkMode={darkMode} name="Wilson Moyer" subtext={['WALL-E Mech Lead']} image={wm2964} />
              ...
              <FaceCard
                darkMode={darkMode}
                name="Ian Henriques"
                subtext={['Pacbot SW Lead', 'Golf Cart SW Lead']}
                image={Ih2422}
              />
